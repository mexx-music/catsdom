const CACHE_NAME = "catsdom-pwa-v28";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=31",
  "./src/app.js?v=31",
  "./src/game-engine.js?v=31",
  "./src/cat-progress.js?v=31",
  "./src/cat-content.js",
  "./src/cat-catalog-repository.js?v=31",
  "./src/cat-asset-store.js?v=31",
  "./src/motion-tuning.js?v=31",
  "./cats/catalog.json",
