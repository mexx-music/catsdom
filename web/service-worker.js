const CACHE_NAME = "catsdom-pwa-v26";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=29",
  "./src/app.js?v=29",
  "./src/game-engine.js?v=29",
  "./src/cat-progress.js?v=29",
  "./src/cat-content.js",
  "./src/cat-catalog-repository.js?v=29",
  "./src/cat-asset-store.js?v=29",
  "./src/motion-tuning.js?v=29",
  "./cats/catalog.json",
