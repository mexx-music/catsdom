const CACHE_NAME = "catsdom-pwa-v29";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=32",
  "./src/app.js?v=32",
  "./src/game-engine.js?v=32",
  "./src/cat-progress.js?v=32",
  "./src/cat-content.js?v=32",
  "./src/cat-catalog-repository.js?v=32",
  "./src/cat-asset-store.js?v=32",
  "./src/motion-tuning.js?v=32",
  "./cats/catalog.json",
